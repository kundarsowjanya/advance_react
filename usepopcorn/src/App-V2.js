    ...
    <>
      ...
      <Main >
       <Box>
         ...
         {isLoading&&<Loader/>}
         {isLoading&&!error?<Loader/>:<MovieList movies={movies} handleSelectedMovie={handleSelectedMovie}/>}
         {error&&<ErrorMessage message={error}/>}
       </Box>
       <Box>
        {  selectedId?<MovieDetail selectedId={selectedId} onCloseMovie={handleCloseMovie} onAddWatched={handleWatched} watched={watched}/>:
        <>
